...
function App() {
  ...
  const [body, setBody] = useState(
    "Making your own marinara sauce is easy, says Fran, the woman who shared this recipe. All you have to do is saute a large can of tomatoes, half an onionMaking your own marinara sauce is easy, says Fran, the woman who shared this recipe. All you have to do is saute a large can of tomatoes, half an onionMaking your own marinara sauce is easy, says Fran, the woman who shared this recipe. All you have to do is saute a large can of tomatoes, half an onionMaking your own marinara sauce is easy, says Fran, the woman who shared this recipe. All you have to do is saute a large can of tomatoes, half an onionMaking your own marinara sauce is easy, says Fran, the woman who shared this recipe. All you have to do is saute a large can of tomatoes, half an onionMaking your own marinara sauce is easy, says Fran, the woman who shared this recipe. All you have to do is saute a large can of tomatoes, half an onionMaking your own marinara sauce is easy, says Fran, the woman who shared this recipe. All you have to do is saute a large can of tomatoes, half an onion       "
  );
        ...
        {preview === null ? (
          <div>
            ...
            <span className="explanation-text">
              The message you've just read ignites an emotional <br /> surge
              that <i>needs</i> an outlet - but DON&apos;T{" "}
              <span>
                {" "}
                <button className="reply-graphic">REPLY</button>
              </span>
              {/* click &quot;REPLY.&quot; */}
              {/* your primitive fight response will only lead to regrets later...  */}
              <span className="e-t">
                <br /> Instead, fire it off <strong>anonymously</strong> to a
                stranger.
              </span>
            </span>
          </div>
